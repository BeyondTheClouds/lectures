...
#+BEGIN_SRC bash
curl https://github.com/BeyondTheClouds/lectures/blob/34c031d/2020-2021/os-polytech/tp.tar.gz?raw=true -o tp.tar.gz -L
tar xzf tp.tar.gz
cd lab-os
#+END_SRC
...
#+LINK: cdn-url      https://github.com/BeyondTheClouds/lectures/blob/34c031d/%s?raw=true
