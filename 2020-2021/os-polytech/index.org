...
with, at least, 8 GiB of RAM and 2 CPU.  If you have a *different
version* of Ubuntu installed on your machine -- use ~lsb_release -d~
to check it out -- you should start a proper VM using, for instance,
the [[*Vagrantfile][Vagrantfile]] given in the Appendix.
...
** COMMENT Access the Lab machine
:PROPERTIES:
...
following SSH command. Use ~os-polytech~ as password.
...
#+BEGIN_SRC bash
curl https://github.com/BeyondTheClouds/lectures/blob/d727179/2020-2021/os-polytech/tp.tar.gz?raw=true -o tp.tar.gz -L
tar xzf tp.tar.gz
cd lab-os
#+END_SRC
...
#+LINK: cdn-url      https://github.com/BeyondTheClouds/lectures/blob/d727179/%s?raw=true
