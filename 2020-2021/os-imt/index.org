...
#+BEGIN_SRC bash
curl https://github.com/BeyondTheClouds/lectures/blob/00fa5fa/2020-2021/os-imt/tp.tar.gz?raw=true -o tp.tar.gz -L
tar xzf tp.tar.gz
cd lab-os
#+END_SRC
...
#+LINK: cdn-url      https://github.com/BeyondTheClouds/lectures/blob/00fa5fa/%s?raw=true
