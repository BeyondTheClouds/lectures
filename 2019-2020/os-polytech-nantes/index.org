...
#+LINK: cdn-url  https://raw.githubusercontent.com/BeyondTheClouds/lectures/master/2019/os-polytech-nantes/%s
...
Find the slides of the lecture [[https://raw.githubusercontent.com/BeyondTheClouds/lectures/master/2018/os-polytech/docs/CloudFogEdgeIntro.pdf][here]] and [[https://raw.githubusercontent.com/BeyondTheClouds/lectures/master/2018/os-polytech/docs/openstack-slides.pdf][there]]. This document is an [[https://orgmode.org/][Org
mode]] document, you can find its source [[cdn-url:index.org][here]].
#+END_abstract
...
hints to check:
- Ping Google and the VM *from the Lab machine*. The ping should work
