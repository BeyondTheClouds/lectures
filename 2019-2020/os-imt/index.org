...
#+LINK: cdn-url      https://github.com/BeyondTheClouds/lectures/blob/93f3ead/%s?raw=true
...
#+BEGIN_SRC bash
curl -O https://github.com/BeyondTheClouds/lectures/blob/93f3ead/2019-2020/os-imt/tp.tar.gz?raw=true
mkdir ~/os-imt
