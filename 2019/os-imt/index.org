...
~rsc/heat_templates/debian/hello_world/~.

*** Boot a VM
The simplest HOT template your can declare describes how to boot a VM:

#+include: "rsc/heat_templates/debian/hello_world/1_boot_vm.yaml" src yaml
...
#+INCLUDE: "rsc/heat_templates/debian/hello_world/2_boot_vm_with_params.yaml" src yaml
...
#+INCLUDE: "rsc/heat_templates/debian/hello_world/3_boot_vm_with_output.yaml" src yaml
...
#+INCLUDE: "rsc/heat_templates/debian/hello_world/4_boot_vm_with_user-data.yaml" src yaml
...
#+INCLUDE: "rsc/heat_templates/debian/hello_world/5_boot_vm_with_user-data2.yaml" src yaml
...
#+INCLUDE: "rsc/heat_templates/debian/hello_world/6_boot_vms_with_exchange.yaml" src yaml
...
#+INCLUDE: "rsc/heat_templates/debian/hello_world/7_nested_template.yaml" src yaml
...
#+INCLUDE: "rsc/heat_templates/debian/hello_world/8_nested_template_boot_vm.yaml" src yaml
...
#+INCLUDE: "rsc/heat_templates/debian/hello_world/8_nested_template_exchange.yaml" src yaml
