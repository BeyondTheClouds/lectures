...
;; Put it in export, to later push on personal website
;; (let ((export-dir (concat default-directory "export")))
;;   (when (file-directory-p export-dir)
;;     (delete-directory export-dir t))
;;
;;   (make-directory export-dir)
;;   (shell-command (fcmd "cp -r " "index.html" "tp.tar.gz" export-dir)))
#+END_SRC
