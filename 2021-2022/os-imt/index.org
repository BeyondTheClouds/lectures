...
[[https://github.com/busyloop/lolcat][~lolcat~]] softwares on the VM. To allow the VM to connect to the
outside world, you will have to execute the script ~to-infinity.sh~,
which you can find in ~rsc/to-infinity.sh~. Be careful, you have to
fill in at the end of the file, after the TODO, the NIC on the lab
machine and its IP.
...
<user>@access.grid5000.fr~ and ~ssh rennes~).
